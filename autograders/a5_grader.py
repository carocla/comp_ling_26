...
errs = 0
embeddings = Embeddings('/projects/e31408/data/a5/glove_top50k_50d.txt')
...
SAT_questions = read_turney_analogies(embeddings, path='/projects/e31408/data/a5/SAT-package-V3.txt')
