...
try:
    ...
    print("doc length is " + str(lda.doc_lengths[17]) + " expected 6")
    print("doc topic counts is " + str(lda.doc_topic_counts[2][2]) + " expected 3")
    print("topic counts is " + str(lda.topic_counts[0]) + " expected 650")
    print("topic word counts is " + str(lda.topic_word_counts[2]['cat']) + " expected 31")
...
try:
    ...
    print(" expected around 0.323809 but got "+ str(lda.theta_d_i(42, 1)))
    errs += 1
...
try:
    ...
    print(" expected around 0.0091111 but got "+ str(lda.phi_i_v(0, 'space')))
    print(" expected around 0.001948 but got "+ str(lda.phi_i_v(2, 'sell')))
    errs += 1
